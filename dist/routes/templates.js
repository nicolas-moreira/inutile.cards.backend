...
export async function templateRoutes(fastify) {
    ...
    fastify.get('/admin/all', { preHandler: [authenticateToken, requireAdmin] }, async (request, reply) => {
        try {
    ...
    fastify.post('/:id/apply', { preHandler: [authenticateToken] }, async (request, reply) => {
        try {
            const { id } = request.params;
    ...
    fastify.put('/:id', { preHandler: [authenticateToken, requireAdmin] }, async (request, reply) => {
        try {
            const { id } = request.params;
    ...
    fastify.delete('/:id', { preHandler: [authenticateToken, requireAdmin] }, async (request, reply) => {
        try {
            const { id } = request.params;
