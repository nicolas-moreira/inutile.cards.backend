...
async function getUniqueSlug(firstName: string, lastName: string): Promise<string> {
...
export async function authRoutes(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.post('/change-password', { preHandler: [authenticateToken] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
